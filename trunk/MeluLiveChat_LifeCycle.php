...
include_once('MeluLiveChat_InstallIndicator.php');

class MeluLiveChat_LifeCycle extends MeluLiveChat_InstallIndicator
{
...
//                         array(&$this, 'settingsPage'));
        ...
        add_menu_page(
            __($displayName, 'textdomain'),
            __($displayName, 'textdomain'),
            'manage_options',
            $this->getSettingsSlug(),
            array(&$this, 'settingsPage'),
            //'/wp-content/plugins/melu-live-chat/data/logo.svg',
            plugins_url( 'data/logo.svg', __FILE__ ),
            31
